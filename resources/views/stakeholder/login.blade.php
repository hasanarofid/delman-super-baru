...
@section('title','Login Stakeholder')
@section('css')
      ...
      <div class="authentication-inner py-4">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <hr>
            <form role="form" method="POST" action="{{ route('stakeholder.login.post') }}">
                @csrf
                <div class="mb-4">
                  <label for="identifier" class="form-label fw-semibold text-dark">Email atau NIP</label>
                  <div class="input-group">
                    ...
                    <input type="text" id="identifier"
                        ...
                        placeholder="Masukkan Email atau NIP Anda" aria-label="Identifier" name="identifier" 
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-lg btn-info btn-lg w-100 mt-4 mb-3 text-white">
