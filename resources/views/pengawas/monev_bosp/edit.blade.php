...
@section('title', 'Edit Laporan Monev BOSP SMK')
@section('titelcard', 'Edit Laporan Monev BOSP SMK')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pengawas.monev-bosp.update', $monev->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="sekolah_id" id="sekolah_id" class="form-select select2" required>
                                    ...
                                    @foreach($sekolahBinaan as $sb)
                                        <option value="{{ $sb->sekolah->id }}" {{ old('sekolah_id', $monev->sekolah_id) == $sb->sekolah->id ? 'selected' : '' }} data-kota="{{ $sb->sekolah->kabupaten->nama_kabupaten ?? '' }}" data-status="{{ $sb->sekolah->status_sekolah ?? 'Swasta' }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status_ijop" id="status_ijop" class="form-select select2" required>
                                    ...
                                    <option value="Berlaku" {{ (old('status_ijop') ?? $monev->status_ijop) == 'Berlaku' ? 'selected' : '' }}>Berlaku</option>
                                    <option value="Kadaluarsa" {{ (old('status_ijop') ?? $monev->status_ijop) == 'Kadaluarsa' ? 'selected' : '' }}>Kadaluarsa</option>
                                    <option value="Sedang Perpanjangan" {{ (old('status_ijop') ?? $monev->status_ijop) == 'Sedang Perpanjangan' ? 'selected' : '' }}>Sedang Perpanjangan</option>
                                    <option value="Tidak Memiliki IJOP" {{ (old('status_ijop') ?? $monev->status_ijop) == 'Tidak Memiliki IJOP' ? 'selected' : '' }}>Tidak Memiliki IJOP</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="bulan" id="bulan" class="form-select" required>
                                    ...
                                    @foreach($bulanOptions as $b)
                                        <option value="{{ $b }}" {{ old('bulan', $monev->bulan) == $b ? 'selected' : '' }}>{{ $b }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="tahun" id="tahun" class="form-control" value="{{ old('tahun', $monev->tahun) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="siswa_kelas_10" id="siswa_kelas_10" class="form-control hitung-siswa" required min="0" value="{{ old('siswa_kelas_10', $monev->siswa_kelas_10) }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="siswa_kelas_11" class="form-label">Jumlah Siswa Kelas 11</label>
                                <input type="number" name="siswa_kelas_11" id="siswa_kelas_11" class="form-control hitung-siswa" required min="0" value="{{ old('siswa_kelas_11', $monev->siswa_kelas_11) }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="siswa_kelas_12" class="form-label">Jumlah Siswa Kelas 12</label>
                                <input type="number" name="siswa_kelas_12" id="siswa_kelas_12" class="form-control hitung-siswa" required min="0" value="{{ old('siswa_kelas_12', $monev->siswa_kelas_12) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="realisasi_bosp_format" class="form-control format-rupiah" required value="{{ old('realisasi_bosp', $monev->realisasi_bosp) }}">
                                <input type="hidden" name="realisasi_bosp" id="realisasi_bosp" value="{{ old('realisasi_bosp', $monev->realisasi_bosp) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="catatan_observasi" id="catatan_observasi" rows="4" class="form-control">{{ old('catatan_observasi', $monev->catatan_observasi) }}</textarea>
                            </div>
                        </div>
