      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <div class="app-brand demo" style="height: 190px !important;">
          <a href="{{ route('pengawas.index') }}" class="app-brand-link">
            <img src="{{ asset('delmansupernew.png') }}" height="200px" width="200px" alt="DelmanSuper Logo"
              class="brand-logo">
          </a>
        ...
        <ul class="menu-inner py-1" style="margin-top: 10px">
          ...
          <li
            class="menu-item {{ (request()->is('dashboard-monev') || request()->is('dashboard-monev/*')) ? 'active' : '' }}">
          ...
          <li class="menu-item {{ (request()->is('pengawas/monev-bosp*')) ? 'active' : '' }}">
            <a href="{{ route('pengawas.monev-bosp.index') }}" class="menu-link">
              <i class="menu-icon tf-icons ti ti-file-report"></i>
              <div data-i18n="Monev Dapodik">Monev Dapodik</div>
            </a>
          </li>
          {{-- <!-- Layouts -->
          <li
            class="menu-item {{ ( request()->is('sekolahbinaan') || request()->is('datapengawas')   ) ? 'active open' : '' }}">
      ...
      <div class="layout-page">
        ...
        <nav
          ...
          <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
            <a class="nav-item nav-link btn btn-icon btn-label-primary rounded-pill px-0 me-xl-4"
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <div class="d-flex align-items-center flex-grow-1 overflow-hidden me-2">
              <!-- Desktop Badge -->
              <div
                class="badge bg-label-success me-2 me-lg-3 py-2 px-3 border border-success d-none d-sm-flex align-items-center">
              ...
              <h5 class="mb-0 fw-bold text-truncate" style="font-size: clamp(0.9rem, 4vw, 1.25rem);">@yield('titelcard')
              </h5>
            </div>
          ...
          <div class="container-fluid">
            <div
              ...
              <div>
                ...
                , made with ❤️ by <a href="{{ route('pengawas.index') }}" target="_blank" class="fw-semibold">Delman
                  Super</a>
              </div>
