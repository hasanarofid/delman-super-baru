...
@section('title', 'Tambah Kategori Umpan Balik')
@section('titelcard', 'Tambah Kategori Umpan Balik')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Tambah Kategori Umpan Balik</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('umpanbalik.categories.store') }}">
                @csrf
