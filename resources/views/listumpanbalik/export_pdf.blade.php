    ...
    <div class="profile-section">
        <table>
            <tr>
                ...
                <td width="2%">:</td>
                <td width="33%">{{ $pengawasProfile->jenjang_jabatan }} - {{ $pengawasProfile->pangkat }} - {{ $pengawasProfile->gol_ruang }}</td>
            </tr>
            <tr>
                ...
                <td>:</td>
                <td>{{ $pengawasProfile->profile->no_telp ?? ($pengawasProfile->no_telp ?? '-') }}</td>
            </tr>
        </table>
    </div>
    @endif
